...
python -m tooltalk.evaluation.evaluate --dataset data/easy --database data/databases --model gpt-4 --output_dir $output_dir/easy
python -m tooltalk.evaluation.evaluate --dataset data/tooltalk --database data/databases --model gpt-4 --output_dir $output_dir/hard
